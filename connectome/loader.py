...
class ConnectomeGraph:
    ...
    def get_sensory_neurons(self) -> List[int]:
        """Get all sensory neuron IDs (MaleCNS v1.0 superclasses)."""
    ...
    def get_motor_neurons(self) -> List[int]:
        """Get all motor neuron IDs (MaleCNS v1.0 superclasses)."""
    ...
    def get_modulatory_neurons(self) -> List[int]:
        """Get all modulatory neuron IDs by neurotransmitter."""
        modulatory_nts = {"dopamine", "octopamine", "serotonin"}
        return [nid for nid, meta in self.neurons.items() if meta.neurotransmitter in modulatory_nts]
